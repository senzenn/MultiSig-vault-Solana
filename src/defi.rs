...
pub mod defi_protocols {
    ...
    pub const ORCA_WHIRLPOOL: Pubkey = Pubkey::new_from_array([
        0x77, 0x68, 0x69, 0x72, 0x4c, 0x62, 0x4d, 0x69, 0x69, 0x63, 0x56, 0x64, 0x69, 0x6f, 0x34,
        0x71, 0x76, 0x55, 0x66, 0x4d, 0x35, 0x4b, 0x41, 0x67, 0x36, 0x43, 0x74, 0x38, 0x56, 0x77,
        0x70, 0x59,
    ]);

    // Raydium AMM Program ID (V4)
    pub const RAYDIUM_AMM: Pubkey = Pubkey::new_from_array([
        0x36, 0x37, 0x35, 0x6b, 0x50, 0x58, 0x39, 0x4d, 0x48, 0x54, 0x6a, 0x53, 0x32, 0x7a, 0x74,
        0x31, 0x71, 0x66, 0x72, 0x31, 0x4e, 0x59, 0x48, 0x75, 0x7a, 0x65, 0x4c, 0x58, 0x66, 0x51,
        0x4d, 0x39,
    ]);

    // Saber Protocol Program ID
    pub const SABER_PROTOCOL: Pubkey = Pubkey::new_from_array([
        0x53, 0x53, 0x77, 0x70, 0x6b, 0x45, 0x45, 0x63, 0x62, 0x55, 0x71, 0x78, 0x34, 0x76, 0x74,
        0x6f, 0x45, 0x42, 0x79, 0x46, 0x6a, 0x53, 0x6b, 0x68, 0x4b, 0x64, 0x43, 0x54, 0x38, 0x36,
        0x32, 0x44,
    ]);

    // Jupiter Aggregator Program ID
    pub const JUPITER_AGGREGATOR: Pubkey = Pubkey::new_from_array([
        0x4a, 0x55, 0x50, 0x36, 0x4c, 0x6b, 0x62, 0x5a, 0x62, 0x6a, 0x53, 0x31, 0x6a, 0x4b, 0x4b,
        0x77, 0x61, 0x70, 0x64, 0x48, 0x4e, 0x79, 0x37, 0x34, 0x7a, 0x63, 0x5a, 0x33, 0x74, 0x4c,
        0x55, 0x5a,
    ]);
}
        ...
        let accounts = vec![
            ...
            AccountMeta::new_readonly(
                Pubkey::new_from_array([
                    0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x6b, 0x65, 0x67, 0x51, 0x66, 0x65, 0x5a, 0x79,
                    0x69, 0x4e, 0x77, 0x41, 0x4a, 0x62, 0x4e, 0x62, 0x47, 0x4b, 0x50, 0x46, 0x58,
                    0x43, 0x57, 0x75, 0x42, 0x76, 0x66,
                ]),
                false,
            ),
